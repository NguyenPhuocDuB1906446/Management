    ...
    actions: {
        ...
        SET_PROVIDERS: async (context) => {
            ...
            try {
                ...
                context.commit('SET_ERROR', err.message || "Đã xảy ra sự cố khi lấy nhà cung cấp.");
                context.commit('SET_PROVIDERS_IS_LOADING', false);
            }
        },
        ADD_PROVIDER: async (context) => {
            try {
                ...
                context.commit('SET_ERROR', err.message || "Đã xảy ra sự cố khi thêm nhà cung cấp.");
            }
        },
        DEL_PROVIDER: async (context, index) => {
            try {
                ...
                context.commit('SET_ERROR', err.message || "Đã xảy ra sự cố khi xóa nhà cung cấp.");
            }
        },
        ...
        SAVE_PROVIDER: async (context, index) => {
            try {
                ...
                context.commit('SET_ERROR', err.message || "Đã xảy ra sự cố khi lưu nhà cung cấp.");
            }
        },
        ...
        SET_CLIENTS: async (context) => {
            ...
            try {
                ...
                context.commit('SET_ERROR', err.message || "Đã xảy ra sự cố khi lấy clients.");
                context.commit('SET_CLIENTS_IS_LOADING', false);
            }
        },
        ...
        DEL_CLIENT: async (context, id) => {
            try {
                ...
                context.commit('SET_ERROR', err.message || "Đã xảy ra sự cố khi xóa clients");
            }
        },
        SAVE_NEW_CLIENT: async (context) => {
            try {
                ...
                context.commit('SET_ERROR', err.message || "Đã xảy ra sự cố khi lưu clients");
            }
        },
    }
});